...
def parse_arguments(parser):
    ...
    parser.add_argument('--data_file', type=str, metavar='<patient_matrix>', default = 'output.matrix', help='The path to the numpy matrix containing aggregated patient records.')
    parser.add_argument('--out_file', type=str, metavar='<out_file>', default = 'D:/Python/tfexample/medgan-master/model/foutput',  help='The path to the output models.')
    # parser.add_argument('--out_file', type=str, metavar='<out_file>', default = 'D:/Python/tfexample/medgan-master/model/foutput',  help='The path to the output models.')

    parser.add_argument('--model_file', type=str, metavar='<model_file>', default='D:/Python/tfexample/medgan-master/model/foutput-99', help='The path to the model file, in case you want to continue training. (default value: '')')
    ...
    parser.add_argument('--n_epoch', type=int, default=100, help='The number of epochs to train medGAN. (default value: 1000)')
    ...
    parser.add_argument('--generate_data', type=str2bool, default=True, help='If True the model generates data, if False the model is trained (default value: False)')
...
if __name__ == '__main__':
    ...
    # data = np.load('output.matrix')
    inputDim = data.shape[1]

    mg = Medgan(
                dataType=args.data_type,
                inputDim=inputDim,
                # dataType='output.types',
                # inputDim=inputDim,
